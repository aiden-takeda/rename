...
1. Use the GitHub MPC server to tell me what pull requests are open and assigned to me.
2. Use the GitHub MPC server to tell me what issues are assigned to me.
